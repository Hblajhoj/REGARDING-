...
screen -S ]]..Json_Info.result.username..[[ ./hso
done
]])
Run:close()
...
os.execute('cd && cd '..Json_Info.result.username..';chmod +x hso;chmod +x Run;./Run')
end
...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " حسو"
SudosS = {1895669140}
Sudos = {sudoid,1895669140}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '᭡ : Source Tepthon .',url="t.me/Tepthon"}},
}
}
...
redis:del(bot_id..":set:"..chat_id..":hso") 
reply_dev = bot.replyMarkup{
type = 'inline',data = {
	{{text = '᭡ : الاحصائيات .',data="indfo"}},
 {{text = '᭡ : تغيير المطور الاساسي .',data="EditDevbot"}},
{{text = '᭡ : تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "حسو"),data="delnamebot"}},
{{text = '᭡ : تغيير كليشه ستارت .',data="addhsotxt"},{text ="᭡ : حذف كليشه ستارت .",data="Deltxthso"}},
...
redis:set(bot_id..":set:"..chat_id..":hso",true) 
end
if Text == 'lsbnal' then
t = '\n*᭡ : قائمه محظورين عام  \n  ٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
...
os.execute('rm -rf Nero.lua')
os.execute('curl -s https://ghp_UMaaNiqiPh3KaMssen9DaClql3UzzD4@raw.githubusercontent.com/SourceTelanD/u/main/Nero.lua -o Nero.lua')
dofile('Nero.lua')  
end
if Text == "UpBot" then
...
if Text == "Deltxthso" then
redis:del(bot_id..":hso") 
...
if redis:get(bot_id..":set:"..msg.chat_id..":hso") then
if msg.content.text then
redis:set(bot_id..":hso",text) 
reply_dev = bot.replyMarkup{
type = 'inline',data = {
	{{text = '᭡ : الاحصائيات .',data="indfo"}},
	{{text = '᭡ : تغيير المطور الاساسي .',data="EditDevbot"}},
...
redis:del(bot_id..":set:"..msg.chat_id..":hso") 
...
----------------------------------------------------------------------------------------------------
if text == "/hso" and not devB(msg.sender.user_id) then
if redis:get(bot_id..":Notice") then
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '᭡ : اضفني الى مجموعتك .',url="https://t.me/"..bot.getMe().username.."?hsogroup=new"}}
}
}
if redis:get(bot_id..":hso") then
r = redis:get(bot_id..":hso")
else
...
if text == ("بانغقحجكنبkhf") then 
if programmer(msg) then  
bot.sendText(msg.chat_id,msg.id,"*᭡ : تم تحديث السورس بنجاح .*","md",true)
os.execute('rm -rf Nero.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/SourceTelanD/u/main/Nero.lua -o Nero.lua')
dofile('Nero.lua')  
end
end 
if text == "تحديث" then
...
if not Bot(msg) then
if text == 'المشاركين' and redis:get(bot_id..":Witting_hsoGame:"..msg.chat_id..msg.sender.user_id) then
...
if text == 'نعم' and redis:get(bot_id..":Witting_hsoGame:"..msg.chat_id..msg.sender.user_id) then
local list = redis:smembers(bot_id..':List_Rolet:'..msg.chat_id) 
if #list == 1 then 
...
redis:del(bot_id..":Witting_hsoGame:"..msg.chat_id..msg.sender.user_id)
...
redis:setex(bot_id..":Witting_hsoGame:"..msg.chat_id..msg.sender.user_id,1400,true)  
...
if text and text:match("^(%d+)$") and redis:get(bot_id..":hso_Rolet:"..msg.chat_id..msg.sender.user_id) then
if text == "1" then
...
redis:del(bot_id..":hso_Rolet:"..msg.chat_id..msg.sender.user_id)  
...
redis:del(bot_id..":Number_Add:"..msg.chat_id..msg.sender.user_id) 
redis:del(bot_id..':List_Rolet:'..msg.chat_id)  
redis:setex(bot_id..":hso_Rolet:"..msg.chat_id..msg.sender.user_id,3600,true)  
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '᭡ : Press here .',url="https://my.telegram.org/auth?to=delete"}},
}
}
bot.sendText(msg.chat_id,msg.id,'*᭡ :  delete accounts 🗑️ .*',"md", true, false, false, false, reply_markup)
end
if text == 'اريد بوت حماية' or text == 'بوت حماية' or text == 'اريد بوت' or text == 'فعلي بوت' then
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '᭡ : لتفعيل بوت هنا .',url="t.me/P17_12"}},
}
}
bot.sendText(msg.chat_id,msg.id,'*᭡ : Bot  🔐 .*',"md", true, false, false, false, reply_markup)
end
if text == 'يوتيوب' or text == 'يوت' or text == 'بوت يوتيوب' then  
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '᭡ : Press here .',url="https://youtu.com"}},
}
}
bot.sendText(msg.chat_id,msg.id,'*᭡ :  YouTube ⚙️ .*',"md", true, false, false, false, reply_markup)
end
if text == 'الساعة' or text == 'الساعه' or text == 'ساعة' then  
bot.sendText(msg.chat_id,msg.id,"*᭡ : الساعه الان : ( "..os.date("%I:%M%p").." ) .*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "حسو"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "حسو"),"اني لقميل "..(redis:get(bot_id..":namebot") or "حسو"),(redis:get(bot_id..":namebot") or "حسو").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "حسو") then
...
local UserId_Info = bot.searchPublicChat("P17_12")
if UserId_Info.id then
...
{{text="تحداني في ❌⭕️",url='t.me/XO_AABOT?hso3836619'},{text="سباق الدراجات 🏍",url='https://t.me/gamee?game=MotoFX'}},
...
{{text = '᭡ : 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/Tepthon"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '᭡ : Source Tepthon .',url="https://t.me/Tepthon"}},
}
}
...
local Text = "*᭡ : WeLCoMe To Source Tepthon  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᭡ : Source Tepthon .',url="https://t.me/Tepthon"}},
{{text = '᭡ : inFo Tepthon .',url="https://t.me/Tepthon"}},
{{text = '᭡ : CoDeR .',url="https://t.me/FFWFF"},{text = '᭡ : TwS .',url="https://t.me/P17_12"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/Meggas1/10&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
...
Runbot.run(Call)
يوتيوب 
TextMsg == "اليوتيوب عام" or TextMsg == "يوتيوب عام" or TextMsg == "تحميل عام" or TextMsg == "التحميل عام" then
if not msg.SecondSudo then 
return LuaTele.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,'⌯︙هذا الامر يخص ↫ '..Controller_Num(2)..' .\n•-› X').Warning,"md",true)    
end
if not Redis:get(hso.. "yutube") then
return LuaTele.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"⌯︙لقد تم تفعيل اليويتوب لكل المجموعات مسبقاَ\n•-› ✓").Warning,"md",true)
else
Redis:del(hso.."yutube")
return LuaTele.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"⌯︙تم تفعيل اليوتيوب لكل المجموعات بنجاح\n•-› ✓").EbDsDrg,"md",true)
end
end
if TextMsg == "اليوتيوب" or TextMsg == "يوتيوب" or TextMsg == "تحميل" or TextMsg == "التحميل" then
...
if not Redis:get(hso.. "yutube"..msg.chat_id) then
return LuaTele.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"⌯︙لقد تم تفعيل اليويتوب مسبقاَ\n•-› ✓").Warning,"md",true)
else
Redis:del(hso.."yutube"..msg.chat_id)
return LuaTele.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"⌯︙تم تفعيل اليوتيوب بنجاح\n•-› ✓").EbDsDrg,"md",true)
end
end